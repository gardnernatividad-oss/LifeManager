...
- La sesión corta no permite revocación individual inmediata; deshabilitar cuenta sí bloquea por consulta DB. Requisitos futuros de sesión larga/dispositivo exigirán una ADR y modelo Session.
