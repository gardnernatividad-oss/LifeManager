# Modelo de datos legado de LifeManager V1 (reemplazado)

> **DOCUMENTO HISTÓRICO Y REEMPLAZADO.** Conservado únicamente para explicar el diseño anterior. ADR-005 y `docs/requirements/Functional.md` reemplazan sus reglas sobre `TaskSeries`, Tareas vinculadas a Proyectos, cancelación, checklist/formulario diario, Categorías desactivables y demás conflictos. No debe utilizarse como fuente para modelos, servicios, APIs ni migraciones nuevas.
