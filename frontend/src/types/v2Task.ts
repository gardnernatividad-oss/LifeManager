...
export interface V2TaskFilters { page: number; page_size: number; planned_from?: string; planned_until?: string; responsible_user_id?: string; master_task_id?: string; category_id?: string; result?: V2TaskResult; unresolved?: boolean; state?: V2TaskState; generated?: boolean; }
export interface V2TaskCreate { master_task_id: string; planned_date: string; responsible_user_id?: string; }
export interface V2TaskUpdate { master_task_id?: string; planned_date?: string; responsible_user_id?: string; lock_version: number; scope?: V2TaskMutationScope; }
