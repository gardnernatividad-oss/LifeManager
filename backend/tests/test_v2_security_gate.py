...
def test_v2_openapi_exposes_only_the_approved_attack_surface() -> None:
    ...
    assert v2_paths == {
        ...
        "/api/v2/auth/login",
            ...
            "/api/v2/review",
            "/api/v2/review/tasks",
            "/api/v2/review/pending-items",
            "/api/v2/review/project-stages",
            "/api/v2/home",
        ...
        "/api/v2/admin/users/{user_id}/disable",
        "/api/v2/admin/users/{user_id}/reactivate",
            "/api/v2/workspaces",
        ...
        "/api/v2/workspaces/{workspace_id}",
            ...
            "/api/v2/workspaces/{workspace_id}/appearance",
